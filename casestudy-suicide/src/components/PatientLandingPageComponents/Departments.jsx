...
<div className='justify-center'>
        ...
        <div className=' justify-between mt-4'>
            <div className='grid grid-cols-2 items-center justify-between ms-3 me-3 border-b-[1px] py-[0.5rem] mb-3'>
                ...
                <div className='flex justify-end items-center text-end ' >
                    ...
                    <input className='ps-3 w-[50%] text-[13px] border-[1px] border-textColor p-1 rounded-[10px]' type="text" placeholder='Search Department Here...' onChange={handleFilter} />
        ...
        <div class="flex  text-center  justify-center shadow-md m-5">
            ...
            <table className='w-full justify-center text-[15px] text-center font-light p-10 py-10' >
                <thead className=" text-[18px] ">
                    ...
                    <tr>
                        ...
                        <th className='px-2 m-5'>Department Location</th>
                        <th className='px-2 m-5'>Facilities</th>
